...
export function Layout({ children }: LayoutProps) {
    ...
    return (
        <div className="min-h-screen flex flex-col font-sans selection:bg-[#6356E5] selection:text-white">
            {/* Header */}
            <header className="fixed top-0 left-0 right-0 z-50 glass-panel transition-all duration-300">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
                    <div className="flex-shrink-0 flex items-center gap-3">
                        ...
                        {isDocs && (
                            <span className="inline-flex items-center px-2 py-0.5 rounded text-xs font-semibold bg-brand-100 text-[#6356E5] border border-brand-200 font-heading">
                                Docs
                            </span>
                        )}
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <button
                            ...
                            className="md:hidden flex items-center justify-center w-10 h-10 rounded-xl bg-white/80 border border-gray-200 shadow-sm text-gray-600 hover:text-[#6356E5] hover:border-brand-200 hover:bg-brand-50 transition-all duration-200"
