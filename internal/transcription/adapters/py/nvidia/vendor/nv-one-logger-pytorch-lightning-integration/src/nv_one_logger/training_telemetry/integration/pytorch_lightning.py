...
# Jotist modification: match Lightning 2.6.6 save_checkpoint weights_only signature.
...
class OneLoggerPTLTrainer(Trainer):
    ...
    @override
    def save_checkpoint(self, filepath: Union[str, Path], weights_only: Optional[bool] = None, storage_options: Optional[Any] = None) -> None:
        ...
        Args:
            ...
            weights_only (bool, optional): If True, only the model's
                weights are saved. None preserves the Lightning Trainer default.
