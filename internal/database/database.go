...
func Initialize(dbPath string) error {
	...
	if err := DB.AutoMigrate(
		...
		&models.RecoveryStage{},
		&models.RecoveryAttempt{},
		&models.RecoveryCheckpoint{},
		&models.RecoveryCheckpointDependency{},
		&models.RecoveryDeletion{},
		&models.AdaptiveObservation{},
		&models.AdaptiveLearnedPlan{},
