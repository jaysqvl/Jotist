...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/profiles/{id}/adaptive-policy": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Optional exact scope fingerprint",
                        "name": "scope_key",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/repository.AdaptivePolicySnapshot"
                        }
                    }
                }
            }
        },
        "/api/v1/profiles/{id}/freeze-adaptive": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "Selected plan ID and expected revision and generation",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.adaptiveProfileAction"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/profiles/{id}/reset-adaptive": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "Expected revision and generation",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/profiles/{id}/restore-revision": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "Saved revision and expected current revision and generation",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "string",
                        "default": "whisper",
                        "description": "Model family from /transcription/models",
                        "name": "model_family",
                        "in": "formData"
                    },
                    {
                        "type": "string",
                        "description": "Checkpoint or Whisper model size; defaults to base for Whisper and the family default for local models",
                        "name": "model",
                        "in": "formData"
                    },
                    {
                        "type": "string",
                        "description": "Meeting context, at most 4000 characters; omitted inherits and empty disables",
                        "name": "transcription_context",
                        "in": "formData"
                    },
                    {
                        "type": "string",
                        "description": "Vocabulary, one term per line, at most 8000 characters; omitted inherits and empty disables",
                        "name": "transcription_context_terms",
                        "in": "formData"
                    },
                    {
                        "type": "integer",
                        "description": "Audio chunk duration in seconds; omit for the model default, 0 requests full-recording context where supported",
                    ...
                    },
                    {
                        ...
                        "type": "string",
                        "default": "pyannote",
                        "description": "Speaker diarization model; native requires an integrated diarizer",
                        "name": "diarize_model",
                        "in": "formData"
                    },
                    {
                        ...
                        "type": "string",
                        "default": "same",
                        "description": "Device used for speaker diarization; same follows the transcription device",
                        "name": "diarization_device",
                        "in": "formData"
                    },
                    {
                        "type": "string",
                        "description": "Optional research diarizer checkpoint, such as rewayai/suplime or rewayai/suplime-large",
                        "name": "diarization_checkpoint",
                        "in": "formData"
                    },
                    {
                        "type": "string",
                    ...
                    {
                        "type": "string",
                        "description": "Compute precision; Whisper defaults to int8, local ASR to float32, and BitNet uses fixed quantized weights",
                        "name": "compute_type",
                        "in": "formData"
                    },
                    {
                        "type": "string",
                        "default": "cpu",
                        "description": "Transcription device; supported choices depend on the model",
                        "name": "device",
                        "in": "formData"
                    },
                    {
        ...
        "/api/v1/transcription/{id}/kill": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Optional expected queue item identity",
                        "name": "request",
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/api.killJobRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/transcription/{id}/queue": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Include terminal queue audit records",
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.TranscriptionQueueResponse"
                        }
                    },
                    "404": {
                        "description": "Not Found",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Queued run request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.QueueTranscriptionRunRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/transcription/{id}/queue/order": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "Complete ordered list of waiting queue item IDs",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.ReorderTranscriptionQueueRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/transcription/{id}/queue/{queue_id}": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/transcription/{id}/rerun": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Transcription parameters or authoritative saved profile ID",
                        "name": "parameters",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.ImmediateTranscriptionRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/transcription/{id}/runs/{run_id}/recovery": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
    ...
    "definitions": {
        ...
        "api.ImmediateTranscriptionRequest": {
            "type": "object",
            "properties": {
                "adaptive_policy": {
                    "$ref": "#/definitions/models.AdaptiveExecutionPolicy"
                },
                "align_model": {
                ...
                "recovery_mode": {
                    "description": "Empty preserves the historical Auto GPU-to-CPU behavior. Explicit fixed\nand stage_management modes never change device, precision, or context.",
                    "type": "string"
                },
                ...
                "reuse_checkpoints": {
                    "description": "Nil means exact-compatible checkpoint reuse is enabled. False requests\nnew artifacts; it never disables durable persistence.",
                    "type": "boolean"
                },
                "segment_resolution": {
                    "type": "string"
                ...
                "transcription_context": {
                    "description": "Nil context fields inherit the requesting user's defaults when a run is\nqueued. A pointer to an empty string explicitly disables that default.",
                    "type": "string"
                },
        ...
        "api.QueueTranscriptionRunRequest": {
            "type": "object",
            "properties": {
                "parameters": {
        ...
        "api.ReorderTranscriptionQueueRequest": {
            "type": "object",
            "properties": {
                "ordered_ids": {
                    "type": "array",
        ...
        "api.TranscriptionQueueResponse": {
            "type": "object",
            "properties": {
                "active_item": {
                    "$ref": "#/definitions/models.TranscriptionQueueItem"
                },
                "cleared": {
                    "type": "integer"
                },
        ...
        "models.AdaptiveExecutionPolicy": {
            ...
            "properties": {
                ...
                "learned_plans": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.AdaptivePlanSnapshot"
                    }
                },
                "learning_generation": {
                    "type": "integer"
                ...
                "stages": {
                    "type": "object",
                    "additionalProperties": {
                        "$ref": "#/definitions/models.AdaptiveStagePolicy"
                    }
                }
            }
        },
        "models.AdaptiveLearnedPlan": {
            ...
            "properties": {
                ...
                "exhaustion_available_bytes": {
                    "type": "integer"
                },
                "exhaustion_capacity_limits": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.AdaptiveCapacityLimit"
                    }
                },
                "exhaustion_evidence_ids": {
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                },
                "full_window_candidate_hashes": {
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                ...
                "scope": {
                    "$ref": "#/definitions/models.AdaptiveLearningScope"
                },
                "scope_key": {
                    "type": "string"
                },
                "settings": {
                    "$ref": "#/definitions/models.AdaptiveStageSettings"
                }
            }
        },
        "models.AdaptiveLearningScope": {
            "type": "object",
            "properties": {
                "fixed_settings_hash": {
                    "type": "string"
        ...
        "models.TranscriptionQueueItem": {
            ...
            "properties": {
                ...
                "status": {
                    "$ref": "#/definitions/models.TranscriptionQueueStatus"
                },
                "transcription_job_id": {
                    "type": "string"
                },
        ...
        "models.TranscriptionQueueStatus": {
            "type": "string",
            "enum": [
                "queued",
                "pending",
        ...
        "repository.AdaptivePolicySnapshot": {
            "type": "object",
            "properties": {
                "learning_generation": {
                    "type": "integer"
                ...
                "observations": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.AdaptiveObservation"
                    }
                },
                "plans": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.AdaptiveLearnedPlan"
                    }
                },
                "profile_id": {
                    "type": "string"
                ...
                "revisions": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.AdaptiveProfileRevision"
                    }
                },
                "selected_plan_id": {
                    "type": "string"
